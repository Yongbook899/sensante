...
# Exercice 2 ET 3
patients = [
    {'age': 10, 'sexe': 'M', 'temperature': 36.8, 'tension_sys': 115,
     'toux': False, 'fatigue': False, 'maux_tete': False, 'region': 'Dakar'},

    {'age': 35, 'sexe': 'F', 'temperature': 40.1, 'tension_sys': 105,
     'toux': True, 'fatigue': True, 'maux_tete': True, 'region': 'Thiès'},

    {'age': 72, 'sexe': 'M', 'temperature': 38.2, 'tension_sys': 98,
...
for p in patients:
    ...
    print(f"Patient {p['age']} ans, {p['sexe']} → {diag} ({proba:.1%})")
